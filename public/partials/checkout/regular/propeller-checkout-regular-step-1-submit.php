...
<form name="checkout" class="form-handler checkout-form validate" method="post" action="">
    ...
    <?php
    if (empty($cart->invoiceAddress->street) && UserController::is_propeller_logged_in())
        apply_filters('propel_checkout_invoice_addresses', $cart, $obj);
    ?>
        ...
        <div class="col-form-fields col-12">
            <div class="row g-3">
                <div class="col-12 col-md-10">
                    <?php if (empty($cart->invoiceAddress->street) && !UserController::is_propeller_logged_in() && PROPELLER_ANONYMOUS_ORDERS) { ?>
                        <div class="alert alert-info mt-4" role="alert">
                            <h4 class="alert-heading d-flex justify-content-start align-items-center">
                                ...
                                <span><?php echo esc_html(__('Invoice address', 'propeller-ecommerce-v2')); ?></span>
                            </h4>
                            <?php echo esc_html(__('Please fill in your invoice address in order to continue', 'propeller-ecommerce-v2')); ?>
                        </div>
                    <?php } else { ?>
