    ...
    <div class="container-fluid px-0 checkout-header-wrapper">
        <div class="row align-items-start">
            <div class="col-12 col-sm me-auto checkout-header">
                <h1><?php echo esc_html(__('Order (Quick Delivery)', 'propeller-ecommerce-v2')); ?></h1>
            </div>
        </div>
    </div>
                ...
                <div class="col-12 col-lg-8">
                    <div class="checkout-wrapper-steps">
                        <div class="row align-items-start">
                            ...
                            <div class="col-12 col-md-7 ms-md-auto order-3 order-md-2 user-details">
                                <div class="user-fullname">
                                    <?php if ($this->cart->invoiceAddress->gender === 'M') {
                                        echo esc_html(__('Mr.', 'propeller-ecommerce-v2'));
                                    } else if ($this->cart->invoiceAddress->gender === 'F') {
                                        echo esc_html(__('Mrs.', 'propeller-ecommerce-v2'));
                                    } else {
                                        echo esc_html('');
                                    }
                        ...
                        <div class="row align-items-start">
                            ...
                            <div class="col-12 col-md-7 ms-md-auto order-3 order-md-2 user-details">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="addr-title shipping-title"><?php echo esc_html(__('Shipping costs', 'propeller-ecommerce-v2')); ?></div>
                                        <div class="user-addr-details">
                                            <?php echo esc_html('<span class="symbol">' . PropellerHelper::currency() . '&nbsp;</span><span class="propel-total-shipping">' . PropellerHelper::formatPrice($this->cart->postageData->price) . '</span>'); ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="checkout-wrapper-steps">
                        <div class="row align-items-start">
                            ...
                            <div class="col-12 col-md-7 ms-md-auto order-3 order-md-2">
                                ...
                                <form name="checkout-notes" class="form-handler checkout-form validate" method="post">
                                    ...
                                    <fieldset>
                                        <div class="row form-group">
                                            <div class="col-form-fields col-12 col-md-8">
                                                <label class="form-label" for="field_notes"><?php echo esc_html(__('Your reference (optional)', 'propeller-ecommerce-v2')); ?></label>
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-12 col-md-8">
                                                        <label class="form-check-label">
                                                            ...
                                                            <span><?php echo esc_html(__('I agree with the', 'propeller-ecommerce-v2')); ?> <a href="/"><?php echo esc_html(__('Terms and Conditions', 'propeller-ecommerce-v2')); ?></a></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row form-group form-group-submit">
                                        <div class="col-form-fields col-12">
                                            <div class="row g-3">
                                                <div class="col-12 col-md-8">
                                                    <button type="submit" class="btn-proceed btn-green"><?php echo esc_html(__('Place an order', 'propeller-ecommerce-v2')); ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
