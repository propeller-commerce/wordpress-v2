...
<form name="checkout-paymethod" class="form-handler checkout-form validate" method="post">
            ...
            <div class="row form-group">
                <div class="col-form-fields col-12">
                    <div class="row px-2 row g-3 form-check carriers radios-container">
                        ...
                        $carriers = $obj->get_carriers_temp()->items;
                    ...
                    <div class="row px-2 d-flex row g-3 form-check deliveries radios-container">
                        ...
                        foreach ($days as $delivery_day) { ?>
                            ...
                            <div class="col-6 col-sm-3 mb-4">
                                <label class="form-check-label delivery <?php echo esc_attr($selected_delivery_date == $delivery_day[2] ? 'selected' : ''); ?>">
                                    <span class="row d-flex align-items-center text-center">
                                        <input type="radio" name="delivery_select" value="<?php echo esc_attr($delivery_day[2]); ?>" title="<?php echo esc_attr(__('Select delivery date', 'propeller-ecommerce-v2')); ?>" data-rule-required="true" required="required" aria-required="true" class="required" <?php echo esc_attr($selected_delivery_date == $delivery_day[2] ? 'checked="checked"' : ''); ?>>
                                        <div class="delivery-day col-12"><?php echo esc_html($delivery_day[0]); ?></div>
                                        <div class="delivery-date col-12"><?php echo esc_html($delivery_day[1]); ?></div>
                                    </span>
                                </label>
                            </div>
                        <?php } ?>
    ...
    <?php } ?>
    <?php apply_filters('propel_checkout_dropshipment_step_3_submit', $cart, $obj); ?>
