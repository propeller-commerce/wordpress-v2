        ...
        <div class="modal-content">
            <div class="modal-header propel-modal-header">
                <div id="propel_modal_edit_title_<?php echo esc_attr($rand); ?>" class="modal-title">
                    <span><?php echo esc_html(__('Add address', 'propeller-ecommerce-v2')); ?></span>
                </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-auto form-group form-check">
                                        <label class="btn-radio-checkbox form-check-label ">
                                            <input type="radio" class="form-check-input" name="gender" value="M" <?php if ($this->cart->deliveryAddress->gender == 'M') echo esc_attr('checked'); ?>> <span><?php echo esc_html(__('Mr.', 'propeller-ecommerce-v2')); ?></span>
                                        </label>
                                    </div>
                                    <div class="col-auto form-group form-check">
                                        <label class="btn-radio-checkbox form-check-label ">
                                            <input type="radio" class="form-check-input" name="gender" value="F" <?php if ($this->cart->deliveryAddress->gender == 'F') echo esc_attr('checked'); ?>> <span><?php echo esc_html(__('Mrs.', 'propeller-ecommerce-v2')); ?></span>
                                        </label>
                                    </div>
                                    <div class="col-auto form-group form-check">
                                        <label class="btn-radio-checkbox form-check-label ">
                                            <input type="radio" class="form-check-input" name="gender" value="U" <?php if ($this->cart->deliveryAddress->gender == 'U') echo esc_attr('checked'); ?>> <span><?php echo esc_html(__('Other', 'propeller-ecommerce-v2')); ?></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="row g-3">
                                    <div class="col-12 col-md-5 form-group col-user-firstname">
                                        ...
                                        <input type="text" name="firstName" value="" placeholder="<?php echo esc_html(__('First name', 'propeller-ecommerce-v2')); ?>*" class="form-control required" id="firstName_<?php echo esc_attr($rand); ?>">
                                    </div>
                                    <div class="col-12 col-md-3 form-group col-user-middlename">
                                        ...
                                        <input type="text" name="middleName" value="" placeholder="<?php echo esc_html(__('Insertion (optional)', 'propeller-ecommerce-v2')); ?>" class="form-control" id="middleName_<?php echo esc_attr($rand); ?>">
                                    </div>
                                    <div class="col-12 col-md-4 form-group col-user-lastname">
                                        ...
                                        <input type="text" name="lastName" value="" placeholder="<?php echo esc_html(__('Last name', 'propeller-ecommerce-v2')); ?>*" class="form-control required" id="lastName_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <fieldset>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="row g-3">
                                    <div class="col-8 form-group col-user-street">
                                        ...
                                        <input type="text" name="street" value="" placeholder="<?php echo esc_html(__('Street', 'propeller-ecommerce-v2')); ?>*" class="form-control required" id="street_<?php echo esc_attr($rand); ?>">
                                    </div>
                                    <div class="col-4 form-group col-user-street-number">
                                        ...
                                        <input type="text" name="number" value="" placeholder="<?php echo esc_html(__('Number', 'propeller-ecommerce-v2')); ?>*" class="form-control required" id="number_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="row g-3">
                                    <div class="col-12 form-group col-user-address_add">
                                        ...
                                        <input type="text" name="numberExtension" value="" placeholder="<?php echo esc_html(__('Apt, suite, unit, etc.(optional)', 'propeller-ecommerce-v2')); ?>" class="form-control" maxlength="7" id="numberExtension_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="row g-3">
                                    <div class="col-12 form-group col-user-zipcode">
                                        ...
                                        <input type="text" name="postalCode" value="" placeholder="<?php echo esc_html(__('Postal code', 'propeller-ecommerce-v2')); ?>*" class="form-control required" id="code_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="row g-3">
                                    <div class="col-12 form-group col-user-city">
                                        ...
                                        <input type="text" name="city" value="" placeholder="<?php echo esc_html(__('City', 'propeller-ecommerce-v2')); ?>*" class="form-control required" id="city_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="row g-3">
                                    <div class="col-12 form-group col-user-address">
                                        ...
                                        <input type="email" name="email" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" value="" placeholder="<?php echo esc_html(__('E-mail', 'propeller-ecommerce-v2')); ?>*" class="form-control required" id="email_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-form-fields col-12">
                                <div class="row g-3">
                                    <div class="col-12 form-group col-user-address">
                                        <label class="form-label" for="telephone_<?php echo esc_attr($rand); ?>"><?php echo esc_html(__('Phone number', 'propeller-ecommerce-v2')); ?>*</label>
                                        <input type="text" name="phone" value="" placeholder="<?php echo esc_html(__('Phone number', 'propeller-ecommerce-v2')); ?>*" class="form-control required" minlength="6" id="telephone_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-form-fields col-12">
                            <div class="row g-3">
                                ...
                                <div class="col d-flex justify-content-end">
                                    <button type="submit" class="btn-modal btn-proceed btn-modal-address btn-modal-submit" id="submit_edit_address<?php echo esc_attr($rand); ?>"><?php echo esc_html(__('Add address', 'propeller-ecommerce-v2')); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
