        ...
        <div class="row">
            <div class="col-12 col-lg-8">
                ...
                <div class="checkout-wrapper-steps">
                    ...
                    <?php echo esc_html(wp_kses_post(apply_filters('propel_checkout_regular_step_2_titles', $this->cart, $this))); ?>

                    <div class="row">
                        <div class="col-12 col-md-10">

                            <?php echo esc_html(wp_kses_post(apply_filters('propel_checkout_regular_step_2_form', $this->cart, $this, $slug))); ?>
