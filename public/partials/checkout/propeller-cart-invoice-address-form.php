...
$selected = !isset($invoice_address->country) || empty($invoice_address->country) ? 'NL' : $invoice_address->country;
?>
        ...
        <div class="modal-content">
            <div class="modal-header propel-modal-header">
                <div id="propel_modal_edit_title_<?php echo esc_attr($rand); ?>" class="modal-title">
                    <span>
                        <?php
                        if (($invoice_address->id !== 0 && $invoice_address->id !== "_guest") || ($invoice_address->id == "_guest" && !empty($invoice_address->street)))
                            echo esc_html(__('Edit invoice address', 'propeller-ecommerce-v2'));
                        else
                            echo esc_html(__('Add invoice address', 'propeller-ecommerce-v2')); ?>
                    </span>
                </div>
            ...
            <div class="modal-body propel-modal-body" id="propel_modal_edit_body_<?php echo esc_attr($rand); ?>">
                <form name="add-delivery-address-form" id="edit_address<?php echo esc_attr($invoice_address->id); ?>" class="form-horizontal validate form-handler modal-edit-form dropshipment-form" method="post">
                    ...
                    <input type="hidden" name="isDefault" value="<?php echo esc_attr(isset($invoice_address->isDefault) ? $invoice_address->isDefault : 'N'); ?>">
                            ...
                            <div class="col-form-fields col-12">
                                <div class="row g-3">
                                    <div class="col-12 form-group col-user-company">
                                        ...
                                        <input type="text" name="company" value="<?php echo esc_attr($invoice_address->company); ?>" placeholder="<?php echo esc_html(__('Company', 'propeller-ecommerce-v2')); ?>*" class="form-control<?php echo esc_attr($company_required); ?>" id="company_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-auto form-group ">
                                        <label class="btn-radio-checkbox -label ">
                                            <input type="radio" class="-input" name="gender" value="M" <?php echo esc_html(($invoice_address->gender == 'M' ? 'checked' : '')); ?>> <span><?php echo esc_html(__('Mr.', 'propeller-ecommerce-v2')); ?></span>
                                        </label>
                                    </div>
                                    <div class="col-auto form-group ">
                                        <label class="btn-radio-checkbox -label ">
                                            <input type="radio" class="-input" name="gender" value="F" <?php echo esc_html(($invoice_address->gender == 'F' ? 'checked' : '')); ?>> <span><?php echo esc_html(__('Mrs.', 'propeller-ecommerce-v2')); ?></span>
                                        </label>
                                    </div>
                                    <div class="col-auto form-group ">
                                        <label class="btn-radio-checkbox -label ">
                                            <input type="radio" class="-input" name="gender" value="U" <?php echo esc_html(($invoice_address->gender == 'U' ? 'checked' : '')); ?>> <span><?php echo esc_html(__('Other', 'propeller-ecommerce-v2')); ?></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="row g-3">
                                    <div class="col form-group col-user-firstname">
                                        ...
                                        <input type="text" name="firstName" value="<?php echo esc_attr($invoice_address->firstName); ?>" placeholder="<?php echo esc_html(__('First name', 'propeller-ecommerce-v2')); ?>*" class="form-control required" id="firstName_<?php echo esc_attr($rand); ?>">
                                    </div>
                                    <div class="col-2 form-group col-user-middlename">
                                        ...
                                        <input type="text" name="middleName" value="<?php echo esc_attr($invoice_address->middleName); ?>" placeholder="<?php echo esc_html(__('Insertion (optional)', 'propeller-ecommerce-v2')); ?>" class="form-control" id="middleName_<?php echo esc_attr($rand); ?>">
                                    </div>
                                    <div class="col form-group col-user-lastname">
                                        ...
                                        <input type="text" name="lastName" value="<?php echo esc_attr($invoice_address->lastName); ?>" placeholder="<?php echo esc_html(__('Last name', 'propeller-ecommerce-v2')); ?>*" class="form-control required" id="lastName_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <?php
                        if ($invoice_address->id === "_guest") { ?>
                            <div class="row form-group">
                                <div class="col-form-fields col-12">
                                    <div class="form-row">
                                        <div class="col form-group col-user-phone">
                                            ...
                                            <input type="text" name="phone" value="<?php echo esc_attr($invoice_address->phone); ?>" placeholder="<?php echo esc_html(__('Phone number', 'propeller-ecommerce-v2')); ?>*" class="form-control required" id="phone_<?php echo esc_attr($rand); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="row g-3">
                                    <div class="col form-group col-user-street">
                                        ...
                                        <input type="text" name="street" value="<?php echo esc_attr($invoice_address->street); ?>" placeholder="<?php echo esc_html(__('Street', 'propeller-ecommerce-v2')); ?>*" class="form-control required" id="street_<?php echo esc_attr($rand); ?>">
                                    </div>
                                    <div class="col form-group col-user-street-number">
                                        ...
                                        <input type="text" name="number" value="<?php echo esc_attr($invoice_address->number); ?>" placeholder="<?php echo esc_html(__('Number', 'propeller-ecommerce-v2')); ?>*" class="form-control required" id="number_<?php echo esc_attr($rand); ?>">
                                    </div>
                                    <div class="col-3 form-group col-user-address_add">
                                        ...
                                        <input type="text" name="numberExtension" value="<?php echo esc_attr($invoice_address->numberExtension); ?>" placeholder="<?php echo esc_html(__('Apt, suite, unit, etc.(optional)', 'propeller-ecommerce-v2')); ?>" class="form-control" maxlength="7" id="numberExtension_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="row g-3">
                                    <div class="col form-group col-user-zipcode">
                                        ...
                                        <input type="text" name="postalCode" value="<?php echo esc_attr($invoice_address->postalCode); ?>" placeholder="<?php echo esc_html(__('Postal code', 'propeller-ecommerce-v2')); ?>*" class="form-control required" id="code_<?php echo esc_attr($rand); ?>">
                                    </div>
                                    <div class="col form-group col-user-city">
                                        ...
                                        <input type="text" name="city" value="<?php echo esc_attr($invoice_address->city); ?>" placeholder="<?php echo esc_html(__('City', 'propeller-ecommerce-v2')); ?>*" class="form-control required" id="city_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="row g-3">
                                    <div class="col-12 form-group col-user-address">
                                        ...
                                        <input type="email" name="email" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" value="<?php echo esc_attr($invoice_address->email); ?>" placeholder="<?php echo esc_html(__('E-mail', 'propeller-ecommerce-v2')); ?>*" class="form-control required" id="email_<?php echo esc_attr($rand); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-form-fields col-12">
                                <div class="row g-3">
                                    <div class="col-12 form-group col-user-notes">
                                        ...
                                        <textarea name="notes" value="<?php echo esc_attr($invoice_address->notes); ?>" placeholder="<?php echo esc_html(__('Remarks (optional)', 'propeller-ecommerce-v2')); ?>" class="form-control" id="notes_<?php echo esc_attr($rand); ?>"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <?php if (!UserController::is_propeller_logged_in() && PROPELLER_ANONYMOUS_ORDERS) { ?>
                            <div class="row form-group">
                                <div class="col-form-fields col-12">
                                    <div class="row g-3">
                                        <div class="col-12 form-group col-use-as-delivery">
                                            <label class="form-label" for="use_as_delivery_<?php echo esc_attr($rand); ?>">
                                                <span class="h4">
                                                    <?php echo esc_html(__('Use this address as delivery address', 'propeller-ecommerce-v2')); ?>
                                                </span>
                                            </label>
                                            <input type="checkbox" name="use_as_delivery_address" value="1" class="form-control" id="use_as_delivery_<?php echo esc_attr($rand); ?>" />
                                        </div>
                                    </div>
                                </div>
                            </div>
