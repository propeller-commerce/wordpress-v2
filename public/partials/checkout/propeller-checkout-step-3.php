                        ...
                        <div class="col-12 col-md-7 col-lg-7 ms-md-auto order-3 order-md-2 user-details">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="user-addr-details">
                                        <?php echo esc_html($this->cart->carrier); ?> - <span class="price"><span class="symbol"><?php echo esc_html(PropellerHelper::currency()); ?>&nbsp;</span>
                                            <?php if (isset($this->cart->carriers) && !empty($this->cart->carriers)) {
                                                foreach ($this->cart->carriers as $carrier) {
                                                    if ($this->cart->carrier == $carrier->name)
                                                        echo esc_html(PropellerHelper::formatPrice($carrier->price));
                                                }
                                            } ?>
                                ...
                                <fieldset>
                                    <div class="row form-group">
                                        <div class="col-form-fields col-12 col-md-8">
                                            <div class="row px-2 d-flex row g-3 form-check paymethods">
                                                    ...
                                                    <div class="col-6 col-md-3 mb-4">
                                                        <label class="form-check-label paymethod">
                                                            <span class="row d-flex align-items-center text-center">
                                                                ...
                                                                <div class="paymethod-cost col-12"><span class="currency"><?php echo esc_html(PropellerHelper::currency()); ?></span> <?php echo esc_html($payMethod->price); ?></div>
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php } ?>
                                    ...
                                    <div class="col-form-fields col-12">
                                        <div class="row g-3">
                                            <div class="col-12 col-md-8">
                                                <button type="submit" class="btn-proceed btn-green"><?php echo esc_html(__('Order overview & payment', 'propeller-ecommerce-v2')); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
