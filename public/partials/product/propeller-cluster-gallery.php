                    ...
                    <div class="gallery-item-slick">
                        <a href='<?php echo esc_url($obj->assets_url . '/img/no-image.webp'); ?>' data-size="450x450">
                            <img src='<?php echo esc_url($obj->assets_url . '/img/no-image.webp'); ?>'
                                ...
                                alt='<?php echo esc_attr(__('No image found', 'propeller-ecommerce-v2')); ?>' width="450"
                                height="450">
                            <span class="zoom-link">
                                <svg class="icon icon-zoom" aria-hidden="true">
                        ...
                        <div class="item">
                            <div class="image">
                                <img src="<?php echo esc_url($image->url); ?>"
                                    alt="<?php echo esc_attr(count($images->alt) ? $images->alt[0]->value : ""); ?>" <?php if ($keyThumbImg > 4) { ?> loading="lazy" <?php } ?>
                ...
                <div class="item">
                    <div class="image">
                        <img src="<?php echo esc_url($obj->assets_url . '/img/no-image-small.webp') ?>" <?php if ($keyThumbImg > 3) { ?> loading="lazy" <?php } ?>
                            alt="<?php echo esc_attr(__('No image found', 'propeller-ecommerce-v2')); ?>" width="120"
                            height="120" />
                    </div>
                </div>
            <?php } ?>
