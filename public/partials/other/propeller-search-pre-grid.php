    ...
    <div class="row align-items-center catalog-result-options">
        ...
        <div class="col-auto d-none d-md-flex align-items-center liststyle-options">
            <div class="input-group">
                <a class="input-group-text btn-liststyle" href="" data-liststyle="list" aria-label="Toon als lijst" rel="nofollow">
                    <span class="icon">
                        <svg class="icon icon-svg" aria-hidden="true">
                ...
                <a class="input-group-text btn-liststyle active" href="" data-liststyle="blocks" aria-label="Toon als blokken" rel="nofollow">
                    <span class="icon">
                        <svg class="icon icon-svg" aria-hidden="true">
...
<?php echo wp_kses_post(apply_filters('propel_selected_filters', $obj)); ?>

<?php if ($data->itemsFound == 0) { ?>
    <div class="row">
        <div class="col-12">
            <h1 class="title <?php echo esc_html(apply_filters('propel_listing_title_classes', '')); ?>"><?php echo esc_html(__('No results', 'propeller-ecommerce-v2')); ?></h1>
            <p>
                <?php echo esc_html(__('No results for', 'propeller-ecommerce-v2')); ?> '<?php echo esc_html(urldecode($prop_value)); ?>' <?php echo esc_html(__('. No results were found that match your search criteria.', 'propeller-ecommerce-v2')); ?>
            </p>
            <p>
