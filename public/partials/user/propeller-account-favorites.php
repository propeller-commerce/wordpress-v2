    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-9">
            <div class="propeller-account-table propeller-favorites-table">
                <h4><?php echo esc_html(__('Favorites', 'propeller-ecommerce-v2')); ?></h4>
                <div class="order-headers d-none d-md-flex">
                    <div class="row w-100 align-items-center">
                        <div class="col-md-4 col-xl-5 description">
                            <?php echo esc_html(__('Product', 'propeller-ecommerce-v2')); ?>
                        </div>
                ...
                <div class="order-product-item">
                    <div class="row g-0 align-items-start">
                        ...
                        <div class="col-9 col-md-3 col-xl-4 pe-5 product-description order-2">
                            ...
                            <div class="product-sku">
                                <?php echo esc_html(__('SKU', 'propeller-ecommerce-v2')); ?>: 9898988
                            </div>
