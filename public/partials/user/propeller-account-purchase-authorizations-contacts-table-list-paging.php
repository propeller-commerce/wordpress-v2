...
if ($data->pages > 1) { ?>
    <div class="col-12">
        <div class="row propeller-account-pagination propeller-purchase-authorizations-contacts-pagination" data-action="purchase_authorizations" data-min="1" data-max="<?php echo esc_html((int) $data->pages); ?>" data-current="<?php echo esc_html((int) $data->page); ?>">
