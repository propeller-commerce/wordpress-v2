...
if ($data->pages > 1) { ?>
    <div class="col-12">
        <div class="row propeller-account-pagination" data-status="<?php echo esc_html( OrderStatus::ORDER_STATUS_NEW ); ?>"  data-action="get_orders" data-min="1" data-max="<?php echo esc_html( (int) $data->pages ); ?>" data-current="<?php echo esc_html( (int) $data->page ); ?>">
