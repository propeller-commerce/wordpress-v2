...
<div class="shopping-cart-totals">
    <div class="row align-items-baseline">
        <div class="col-12">
            <div class="sc-items"><?php echo esc_html(__('Overview', 'propeller-ecommerce-v2')); ?> (<span class="propel-total-items"><?php echo esc_html($items_count); ?></span> <?php echo esc_html(__('items', 'propeller-ecommerce-v2')); ?>)</div>
            <hr>
        </div>
    </div>
    <?php foreach ($cart->items as $item) {
    ?>
        <div class="row g-0 align-items-start sc-item">
    ...
    <div class="row g-0 sc-totals">
        <div class="col-12 col-md-7 col-lg-6 col-xl-5 ms-auto">
            ...
            <div class="row align-items-baseline sc-calculation">
                <div class="col-6 col-lg-6 col-xl-5"><?php echo esc_html(__('Shipping costs', 'propeller-ecommerce-v2')); ?></div>
                <div class="col-6 ms-auto sc-price text-end">
                    <div class="sc-total">
            ...
            <div class="sc-grand-total">
                <div class="row align-items-baseline">
                    <div class="col-6 col-lg-6 col-xl-5"><?php echo esc_html(__('Total', 'propeller-ecommerce-v2')); ?></div>
                    <div class="col-6 ms-auto sc-price text-end">
                        <div class="sc-total">
