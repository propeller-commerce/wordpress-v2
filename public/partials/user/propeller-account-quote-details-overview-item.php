...
<div class="order-product-item">
    <div class="row g-0 align-items-start">
        ...
        <div class="col-10 col-md-4 col-lg-5 pe-5 product-description">
            <?php if (is_object($item->product->cluster)) { ?>
        ...
        <div class="col-3 col-md-2 order-discount order-4">
            ...
            <?php if ($item->discount > 0) { ?>
                <span class="discount">
                    ...
                    <?php echo esc_html($item->product->price->gross > 0 ? '(' . PropellerHelper::percentage_from_price($item->price, $item->originalPrice) . '%)' : ''); ?>
                </span>
