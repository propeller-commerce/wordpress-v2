    ...
    <div class="row propeller-account-header">
        <div class="col-12">
            <div class="salutation">
                <?php echo esc_html(__('Welcome', 'propeller-ecommerce-v2')); ?> <span class="fullname"><?php echo esc_html(SessionController::get(PROPELLER_USER_DATA)->firstName); ?> <?php echo esc_html(SessionController::get(PROPELLER_USER_DATA)->middleName); ?> <?php echo esc_html(SessionController::get(PROPELLER_USER_DATA)->lastName); ?></span>
            </div>
        </div>
    </div>
        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse " id="propeller-account-menu">
                <ul class="navbar-nav d-block w-100">
                    ...
                    <li>
                        <a href="<?php echo esc_url($this->buildUrl(PageController::get_slug(PageType::MY_ACCOUNT_MOBILE_PAGE), PageController::get_slug(PageType::PRODUCT_REQUEST_PAGE))); ?>" class="<?php if ($wp->request == PageController::get_slug(PageType::PRODUCT_REQUEST_PAGE)) echo 'active'; ?>">
                            <span><?php echo esc_html(__('Price requests', 'propeller-ecommerce-v2')); ?></span>
                            <svg class="icon icon-svg" aria-hidden="true">
                                <use xlink:href="#shape-arrow-right"></use>
                            </svg>
                        </a>
                    ...
                    <?php if (UserController::user() && UserController::user()->is_authorization_manager()) { ?>
                        <li>
                            <a href="<?php echo esc_url($this->buildUrl(PageController::get_slug(PageType::MY_ACCOUNT_MOBILE_PAGE), PageController::get_slug(PageType::PURCHASE_AUTHORIZATIONS_PAGE))); ?>" class="<?php if ($wp->request == PageController::get_slug(PageType::PURCHASE_AUTHORIZATIONS_PAGE)) echo 'active'; ?>">
                    ...
                    <?php if (UserController::user() && UserController::user()->is_authorization_manager()) { ?>
                        <li>
                            <a href="<?php echo esc_url($this->buildUrl(PageController::get_slug(PageType::MY_ACCOUNT_MOBILE_PAGE), PageController::get_slug(PageType::PURCHASE_AUTHORIZATION_REQUESTS_PAGE))); ?>" class="<?php if ($wp->request == PageController::get_slug(PageType::PURCHASE_AUTHORIZATION_REQUESTS_PAGE)) echo 'active'; ?>">
