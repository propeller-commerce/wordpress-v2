...
<div class="container-fluid px-0 propeller-account-wrapper">
    <script type="application/ld+json">
        {
            ...
            "itemListElement": [{
                ...
                },
                {
                    ...
                    "item": {
                        "@type": "Thing",
                        "@id": "<?php echo esc_url($this->buildUrl('', PageController::get_slug(PageType::PURCHASE_AUTHORIZATIONS_PAGE))); ?>",
                        "name": "<?php echo esc_attr(__("Authorization settings", "propeller-ecommerce-v2")); ?>
                    }
                }
            ]
        }
    ...
    <div class="row">
        <div class="col">
            ...
            $breadcrumb_paths = [
                ...
                [
                    $this->buildUrl('', PageController::get_slug(PageType::PURCHASE_AUTHORIZATIONS_PAGE)),
                    __('Authorization settings', 'propeller-ecommerce-v2')
                ]
            ];
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-9">
            ...
            <?php apply_filters('propel_account_purchase_authorizations_contacts_table', $purchase_authorizations_contacts, $this); ?>
